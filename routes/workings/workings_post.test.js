    ...
    describe("POST /workings", () => {
                    ...
                    it("job_ending_time_year > this year - 10", () =>
                        request(app)
                            ...
                            .send(
                                generateWorkingTimeRelatedPayload({
                                    is_currently_employed: "no",
                                    job_ending_time_year: (new Date().getFullYear() -
                                        10).toString(),
                                    job_ending_time_month: "1",
                                })
                            )
                            ...
                            .send(
                                generateWorkingTimeRelatedPayload({
                                    ...
                                    job_ending_time_year: now
                                        .getFullYear()
                                        .toString(),
                                    job_ending_time_month: (now.getMonth() +
                                        1).toString(),
                                })
                            )
                            .expect(200);
                            ...
                            .send(
                                generateWorkingTimeRelatedPayload({
                                    ...
                                    job_ending_time_year: nextMonth
                                        .getFullYear()
                                        .toString(),
                                    job_ending_time_month: (nextMonth.getMonth() +
                                        1).toString(),
                                })
                            )
                            .expect(422);
        ...
        describe("Quota Check Part", () => {
            it("只能新增 5 筆資料", () => {
                ...
                return Promise.all(requestPromiseStack)
                    .then(() =>
                        request(app)
                            .post("/workings")
                            .send(
            ...
            it("新增 2 筆資料，quries_count 會顯示 2", () =>
                request(app)
                    .post("/workings")
                    .send(
                        generateWorkingTimeRelatedPayload({
        ...
        describe("status part", () => {
            it("status can be `hidden`", () =>
                request(app)
                    .post("/workings")
                    .send(
                        generateWorkingTimeRelatedPayload({ status: "hidden" })
                    )
                    .expect(200)
                    .expect(res => {
