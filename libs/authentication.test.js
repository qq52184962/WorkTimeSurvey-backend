...
const cachedFacebookAuthentication =
    authentication.cachedFacebookAuthentication;
...
describe("Authentication Library", () => {
    describe("cachedFacebookAuthentication", () => {
        ...
        it("resolve if cached", () => {
            ...
            const redisGetFB = sandbox
                .stub(_redis, "redisGetFB")
                .withArgs(redis_client, "fake_accesstoken")
                .resolves(response);

            const main = cachedFacebookAuthentication(
                db,
                redis_client,
                "fake_accesstoken"
            );
        ...
        it("resolve if not cached but access_token is valid", () => {
            ...
            const redisSetFB = sandbox.stub(_redis, "redisSetFB").resolves();
